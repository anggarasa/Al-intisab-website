<div x-data="{ showModal: false, modalDelete: false }">
    ...
    {{-- Modal crud agama --}}
    <div x-show="showModal" @modal-crud-agama.window="showModal = true"
    ...
    <div x-show="modalDelete" @modal-delete-agama.window="modalDelete = true"
        @close-modal-delete-agama.window="modalDelete = false" class="fixed inset-0 z-30 overflow-y-auto"
        style="display: none">
        ...
        <div class="relative flex items-center justify-center min-h-screen p-4">
            <div class="relative w-full max-w-md p-6 bg-white rounded-xl shadow-lg">
                ...
                <p class="text-sm text-center text-gray-500 mb-6">
                    ...
                    <span class="font-medium text-gray-900">{{ $agama }}</span>? Tindakan ini
                    tidak
                    dapat dibatalkan.
                </p>
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <button type="button" wire:click="deleteAgama"
