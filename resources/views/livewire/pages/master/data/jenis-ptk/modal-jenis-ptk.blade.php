<div x-data="{ showModal: false, modalDelete: false }">
    ...
    {{-- Modal PTK --}}
    <div x-show="showModal" @modal-crud-ptk.window="showModal = true" @close-modal-crud-ptk.window="showModal = false"
    ...
    <div x-show="modalDelete" @modal-delete-ptk.window="modalDelete = true"
        @close-modal-delete-ptk.window="modalDelete = false" class="fixed inset-0 z-30 overflow-y-auto"
        style="display: none">
        ...
        <div class="relative flex items-center justify-center min-h-screen p-4">
            <div class="relative w-full max-w-md p-6 bg-white rounded-xl shadow-lg">
                ...
                <p class="text-sm text-center text-gray-500 mb-6">
                    ...
                    <span class="font-medium text-gray-900">{{ $ptk }}</span>? Tindakan ini
                    tidak
                    dapat dibatalkan.
                </p>
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <button type="button" wire:click="deletePtk"
