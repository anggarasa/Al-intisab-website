    ...
    <div class="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Kelola jurusan Smk Al-Intisab
            </p>
        </div>
        <livewire:pages.master.data.jurusan.modal-manajemen-jurusan />
    </div>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center">
                            <div class="flex flex-col items-center space-y-2 text-gray-500">
                                ...
                                <p class="text-lg font-semibold">Data jurusan tidak ditemukan</p>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex space-x-2">
                                ...
                                <button type="button" wire:click="hapusJurusan({{ $jurusan->id }})"
