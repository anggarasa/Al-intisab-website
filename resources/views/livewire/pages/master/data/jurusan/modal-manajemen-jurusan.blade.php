<div x-data="{ showModal: false, modalDelete: false }">
    ...
    {{-- Modal Jurusan --}}
    <div x-show="showModal" @modal-crud-jurusan.window="showModal = true"
        @close-modal-crud-jurusan.window="showModal = false"
        class="fixed inset-0 bg-black bg-opacity-50 z-30 flex items-center justify-center p-4" x-transition>
        <div class="bg-white rounded-xl max-w-md w-full p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold text-gray-800">{{ $isEdit == true ? 'Update' : 'Tambah' }} Jurusan</h3>
            ...
            <form wire:submit="{{ $isEdit == true ? 'updateJurusan' : 'tambahJurusan' }}">
                <input type="text" wire:model="jurusan" placeholder="Nama Jurusan"
    ...
    <div x-show="modalDelete" @modal-delete-jurusan.window="modalDelete = true"
        @close-modal-delete-jurusan.window="modalDelete = false" class="fixed inset-0 z-30 overflow-y-auto"
        style="display: none">
        ...
        <div class="relative flex items-center justify-center min-h-screen p-4">
            <div class="relative w-full max-w-md p-6 bg-white rounded-xl shadow-lg">
                ...
                <p class="text-sm text-center text-gray-500 mb-6">
                    ...
                    <span class="font-medium text-gray-900">{{ $jurusan }}</span>? Tindakan ini
                    tidak
                    dapat dibatalkan.
                </p>
                ...
                <div class="flex justify-center space-x-3">
                    ...
                    <button type="button" wire:click="deleteJurusan"
