<div class="p-4 mt-16" x-data="{ modalShowGuru: null }">
    <!-- Header Section -->
    <div class="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
        ...
        <livewire:pages.master.user.guru.modal-manajemen-guru />
    </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-300">
                    ...
                    <tr class="hover:bg-gray-50" @click="modalShowGuru = 'modal-show-guru_{{ $guru->id }}'">
                                ...
                                <ul class="py-2 text-sm text-gray-900">
                                    ...
                                    <li>
                                        <a @click="dropdownStatus = false; $wire.updateStatusGuru({{ $guru->id }}, 'TIDAK AKTIF')"
                                            @click.stop class="block px-4 py-2 cursor-pointer hover:bg-gray-300">Tidak
                                            Aktif</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ date('d F Y', strtotime($guru->tanggal_lahir)) }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $guru->kelamin ? $guru->kelamin->kelamin : '-' }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    {{-- Modal show guru --}}
                    <div x-show="modalShowGuru === 'modal-show-guru_{{ $guru->id }}'"
                                ...
                                <div class="p-8">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                        ...
                                        <div class="md:col-span-1">
                                            <div
                                                class="rounded-2xl bg-gradient-to-br from-green-50 to-green-100 p-2 shadow-lg">
                                                <div
                                                    class="aspect-square rounded-xl overflow-hidden ring-4 ring-white shadow-inner">
                                                    @if ($guru->foto)
                                                    <img src="{{ asset('storage/'. $guru->foto) }}"
                                                        alt="{{ $guru->name }}" class="w-full h-full object-cover" />
                                                    @else
                                        ...
                                        <div class="md:col-span-2 space-y-8">
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">NIP</label>
                                                        <p class="mt-1 text-gray-900 font-medium">
                                                            {{ $guru->nip }}
                                                        </p>
                                                    </div>
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">NIK</label>
                                                        <p class="mt-1 text-gray-900 font-medium">
                                                            {{ $guru->nik }}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">Agama</label>
                                                        <p class="mt-1 text-gray-900 font-medium">{{ $guru->agama ?
                                                            $guru->agama->agama : '(Kosong)'
                                                            }}</p>
                                                    </div>
                                                    <div>
                                                        <label
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-500">Status
                                                            Kepegawaian</label>
                                                        <p class="mt-1 text-gray-900 font-medium">{{
                                                            $guru->status_kepegawaian }}</p>
                                                    </div>
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">PTK</label>
                                                        @if ($guru->ptk)
                                                        <p class="mt-1 text-gray-900 font-medium">
                                                            {{ $guru->ptk->jenis_ptk }}
                                                        </p>
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-500">Tempat
                                                            Lahir</label>
                                                        <p class="mt-1 text-gray-900 font-medium">{{ $guru->tempat_lahir
                                                            }}</p>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div class="sm:col-span-2">
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">Alamat</label>
                                                        <p class="mt-1 text-gray-900 font-medium">
                                                            {{ $guru->alamat }}
                                                        </p>
                                                    </div>
