<div class="p-4 mt-16" x-data="{modalShowSiswa: null}">
    <!-- Header Section -->
    <div class="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
        ...
        <livewire:pages.master.user.siswa.modal-manajemen-siswa />
    </div>
                                        ...
                                        <div class="md:col-span-1">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    @if ($siswa->foto)
                                                    <img src="{{ asset('storage/'. $siswa->foto) }}"
                                                        alt="{{ $siswa->name }}" class="w-full h-full object-cover" />
                                                    @else
                                                    <img src="{{ asset('imgs/component/profile/avatar-man.jpg') }}"
                                                        alt="{{ $siswa->name }}" class="w-full h-full object-cover" />
                                                    @endif
                                        ...
                                        <div class="md:col-span-2 space-y-8">
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">NISN</label>
                                                        <p class="mt-1 text-gray-900 font-medium">
                                                            {{ $siswa->nisn }}
                                                        </p>
                                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">Kelas</label>
                                                        @if ($siswa->kelas)
                                                        <p class="mt-1 text-gray-900 font-medium">{{
                                                    ...
                                                    <div>
                                                        <label
                                                            class="block text-sm font-medium text-gray-500">Jurusan</label>
                                                        @if ($siswa->jurusan)
                                                        <p class="mt-1 text-gray-900 font-medium">
